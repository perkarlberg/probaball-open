...
T = {
    "sv": {
        ...
        "team_p2": "Lagets styrka väger samman lagrankingar (Elo), bookmakerodds och expertprediktioner (40/40/20). I FIFA-rankingen ligger {name} #{r} av de 48 lagen i turneringen.",
        "group_link": "Grupp {g}",
    ...
    "en": {
        ...
        "team_p2": "The team's strength weights team rankings (Elo), bookmaker odds and expert predictions (40/40/20). In the FIFA ranking {name} sits #{r} of the 48 teams in the tournament.",
        "group_link": "Group {g}",
    ...
    "es": {
        ...
        "team_p2": "La fuerza del equipo pondera rankings (Elo), cuotas de apuestas y predicciones de expertos (40/40/20). En el ranking FIFA, {name} ocupa el puesto #{r} de los 48 equipos del torneo.",
        "group_link": "Grupo {g}",
    ...
    "fr": {
        ...
        "team_p2": "La force de l'équipe pondère les classements (Elo), les cotes des bookmakers et les pronostics d'experts (40/40/20). Au classement FIFA, {name} occupe la place n°{r} sur les 48 équipes du tournoi.",
        "group_link": "Groupe {g}",
    ...
    "pt": {
        ...
        "team_p2": "A força da seleção pondera rankings (Elo), odds de apostas e previsões de especialistas (40/40/20). No ranking FIFA, {name} está em #{r} das 48 seleções do torneio.",
        "group_link": "Grupo {g}",
    ...
    "de": {
        ...
        "team_p2": "Die Stärke des Teams gewichtet Rankings (Elo), Buchmacherquoten und Expertenprognosen (40/40/20). Im FIFA-Ranking liegt {name} auf Platz #{r} der 48 Teams im Turnier.",
        "group_link": "Gruppe {g}",
